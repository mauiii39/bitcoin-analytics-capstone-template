...
This document explains the backtesting framework in `base/base_backtest.py` and how to interpret its results for evaluating the dynamic DCA weight computation model.
